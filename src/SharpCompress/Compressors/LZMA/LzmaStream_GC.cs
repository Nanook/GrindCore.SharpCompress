...
public class LzmaStream : Stream, IStreamStack
{
    ...
    /// <summary>
    /// Number of compressed bytes consumed from the input stream.
    /// Used by LZipStream for trailer validation.
    /// </summary>
    internal long CompressedBytesRead => _grindCoreStream?.Position ?? 0;
}
