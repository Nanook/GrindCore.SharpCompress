...
public class GrindCoreZipWriteStreamBufferTests
{
    ...
    public void GrindCore_CompressionStream_BufferSize_Performance_Test(
    ...
    )
    {
        ...
        )
        {
            ...
            if (
                ...
                ) && encoder is LzmaStream lzmaEncoder
            )
            {
        ...
        var bufferInfo = compressionBufferSize switch
        {
            ...
            > 0 =>
                $"DefaultBufferSize={defaultBufferSize:X}/CompressionBufferSize={compressionBufferSize:X}",
            _ => $"DefaultBufferSize={defaultBufferSize:X}",
        };

        Debug.WriteLine(
            $"{algorithmName} Level={level} {bufferInfo}: "
        ...
        Assert.True(
            compressionTime >= 0 && decompressionTime >= 0,
        ...
        if (compressionType == CompressionType.LZMA || compressionType == CompressionType.LZMA2)
        {
            if (compressionBufferSize > 0)
            {
                ...
                Assert.True(
                    ...
                    $"{algorithmName} with large compression buffer should achieve excellent compression"
                );
            }
            ...
            if (effectivelyLzma2 && compressionBufferSize == -1)
            {
                ...
                Assert.True(
                    ...
                    "LZMA2 solid mode should achieve exceptional compression"
                );
            }
        }
        else if (compressionType == CompressionType.LZ4)
        {
            ...
            Assert.True(
                ...
                "LZ4 should achieve reasonable compression on text data"
            );
        }
        else if (compressionType == CompressionType.Brotli)
        {
            ...
            Assert.True(
                ...
                "Brotli should achieve excellent compression on text data"
            );
        }
        else if (compressionType == CompressionType.ZStandard)
        {
            ...
            Assert.True(
                ...
                "ZStandard should achieve excellent compression on text data"
            );
        }
        else if (compressionType == CompressionType.Xz)
        {
            ...
            Assert.True(
                compressionRatio < 0.1,
                "XZ should achieve excellent compression on text data"
            );
        }
    }
    ...
    private static WriterOptions CreateWriterOptions(
        CompressionType compressionType,
        int level,
        int compressionBufferSize
    )
    ...
    private static int GetTestDataSize(CompressionType compressionType, bool isLzma2 = false) =>
    ...
    private static void VerifyCompressionQuality(
        CompressionType compressionType,
        bool isLzma2,
        int level,
                ...
                switch (level)
                {
                    case 1: // Fastest
                        Assert.True(
                            ...
                            "Even fastest should compress text reasonably"
                        );
                        break;
                    case 9: // Best compression
                        Assert.True(
                            compressionRatio < 0.15,
                            "Best compression should achieve excellent compression"
                        );
                        break;
                    default: // Optimal levels
                        Assert.True(
                            compressionRatio < 0.2,
                            "Optimal compression should achieve good compression"
                        );
                        break;
                }
                break;
            ...
            case CompressionType.LZMA2:
                ...
                if (effectivelyLzma2)
                {
                    ...
                    Assert.True(
                        ...
                        "LZMA2 should achieve excellent compression on text data"
                    );
                }
                else
                {
                    Assert.True(
                        compressionRatio < 0.1,
                        "LZMA should achieve excellent compression on text data"
                    );
                }
                break;
                ...
                switch (level)
                {
                    case 1: // Fastest
                        Assert.True(
                            ...
                            "LZ4 fastest should still compress text reasonably"
                        );
                        break;
                    case 12: // Best compression
                        Assert.True(
                            compressionRatio < 0.4,
                            "LZ4 best compression should achieve good compression"
                        );
                        break;
                ...
                switch (level)
                {
                    case 1: // Fastest
                        Assert.True(
                            ...
                            "Brotli fastest should still compress text well"
                        );
                        break;
                    case 11: // Best compression
                        Assert.True(
                            compressionRatio < 0.08,
                            "Brotli best compression should achieve excellent compression"
                        );
                        break;
                    default: // Mid-range levels
                        Assert.True(
            ...
            case CompressionType.ZStandard:
                switch (level)
                {
                    case 1: // Fastest
                        Assert.True(
                            compressionRatio < 0.3,
                            "ZStandard fastest should still compress text well"
                        );
                        break;
                    case 22: // Best compression
                        Assert.True(
                            compressionRatio < 0.05,
                            "ZStandard best compression should achieve exceptional compression"
                        );
                        break;
                    default: // Mid-range levels
                        Assert.True(
            ...
            case CompressionType.Xz:
                switch (level)
                {
                    case 1: // Fastest
                        Assert.True(
                            compressionRatio < 0.3,
                            "XZ fastest should still compress text well"
                        );
                        break;
                    case 9: // Best compression
                        Assert.True(
                            compressionRatio < 0.08,
                            "XZ best compression should achieve excellent compression"
                        );
                        break;
                    default: // Mid-range levels
                        Assert.True(
